    ...
    <footer className="bg-[#333333] text-[#FAFAF7]">
      <div className="max-w-6xl mx-auto px-4 py-12 md:py-20">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4 mt-4">
              <a
                ...
                className="text-[#FAFAF7]/80 hover:text-[#25D366] transition-colors duration-300"
                aria-label="WhatsApp"
              >
                <svg
                  className="w-6 h-6"
        ...
        <div className="border-t border-white/10 pt-8 mt-12 md:mt-16">
          <p className="text-sm text-gray-300 text-center font-body">
            © {currentYear} Criti Developers LLP. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
